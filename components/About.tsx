          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="mt-12 pt-8 border-t border-gray-100">
              ...
              <p className="text-sm text-gray-500 leading-relaxed font-medium">
                Operating under strict operational protocols to support independent brands, private label programs, and OEM custom projects with verified manufacturing outcomes.
              </p>
            </div>
          </div>
          <div className="order-1 lg:order-2">
            <div className="relative h-[600px] bg-gray-100 border border-gray-200 shadow-sm overflow-hidden">
              ...
              <div className="absolute bottom-8 left-8 flex items-center gap-4">
                 ...
                 <div>
                    <p className="text-white text-[11px] font-black uppercase tracking-[0.3em] mb-1">Standard Operating Procedure</p>
                    <p className="text-white/80 text-[10px] font-bold uppercase tracking-[0.2em]">Institutional Oversight & Operational Engineering</p>
                 </div>
              </div>
            </div>
          </div>
